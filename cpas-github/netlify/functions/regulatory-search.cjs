...
const ACRONYMS = {
  ...
  "anosca":   { terms: ["administrator notification significant contract action","1805.303"], sections: ["1805.303","1849.21"] },
  ...
  "npa":      { terms: ["NASA notification contract action procurement announcement","1805.303"], sections: ["1805.303"] },
  ...
  "pr":       { terms: ["purchase requisition procurement request","1804.7301"], sections: ["1804.7301"] },
  ...
  "sse":      { terms: ["sole source exception unique source","6.302","6.103"], sections: ["6.302","6.103"] },
  "sole source": { terms: ["sole source other than full open competition 6.302","6.103"], sections: ["6.302","6.103","6.104"] },
