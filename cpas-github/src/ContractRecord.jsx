...
function ContractForm({ record, intake, onSaved, onBack }) {
  ...
  async function addMod(mod) {
    try {
      await sbFetch("cpas_contract_mods", {
        method: "POST",
        body: JSON.stringify({ ...mod, contract_id: record?.id, contract_number: form.contract_number }),
      });
  ...
  async function addREA(rea) {
    try {
      await sbFetch("cpas_rea_claims", {
        method: "POST",
        body: JSON.stringify({ ...rea, contract_id: record?.id, contract_number: form.contract_number }),
      });
