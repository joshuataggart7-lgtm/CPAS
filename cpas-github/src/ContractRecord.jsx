...
function ContractForm({ record, intake, onSaved, onBack }) {
  ...
  const [form, setForm] = useState(() => ({
    ...
    pending_actions: "", award_file_link: "", tags: "",
  ...
  async function save() {
    ...
    try {
      ...
      const payload = {
        ...
        over_10m: parseFloat(form.current_value || 0) >= 10000000,
          ...
          <div style={card}>
            ...
            <div style={{ marginTop: 4 }}>
              ...
              <input value={form.tags || ""} onChange={e => set("tags", e.target.value)} style={inp}
                placeholder="e.g. NRA, Commercial, Interagency, Cost-Share, Recompete, Stop Work" />
              <div style={{ fontSize: 10, color: C.muted, marginTop: 4 }}>
                Comma-separated. Used for filtering and data call scoping.
              </div>
            </div>
          </div>
