...
const STATUS_COLOR = {
  REQUIRED:    { bg: "#e8f7f0", border: "#e8f7f0", text: "#0f6e56", badge: "#e8f7f0" },
  CONDITIONAL: { bg: "#fff8e6", border: "#854f0b", text: "#854f0b", badge: "#fff8e6" },
  OPTIONAL:    { bg: "#ffffff", border: "#1a3a6e", text: "#5a3a9e", badge: "#1a3a6e" },
};
    ...
    return (
      <div style={{ borderBottom: `1px solid ${C.border}`, background: isExpanded ? sc.bg : "transparent" }}>
        ...
        >
          ...
          {/* Fill-in indicator */}
          {hasFillIns && (
            <span style={{ fontSize: 9, background: "#1a3a6e", border: "1px solid #3a3a8a",
                           color: "#5a3a9e", padding: "1px 5px", borderRadius: 3, marginLeft: 4 }}>
              FILL-IN
            </span>
          )}
    ...
    <div style={{ background: C.bg, color: C.text, fontFamily: "FONT_COMP", fontSize: 12 }}>
          ...
          {EXTRA_PARAMS.map(ep => (
            <div
              ...
              style={{ display: "flex", alignItems: "center", gap: 5, cursor: "pointer",
                       ...
                       border: `1px solid ${extraParams[ep.key] ? "#e8f7f0" : C.border}`,
      ...
      {activeTab === "MATRIX" && (
        <div style={{ overflow: "auto", maxHeight: "60vh" }}>
          ...
          {/* Conditional */}
          <div style={{ padding: "8px 20px 4px", background: "#fff8e6", fontSize: 9, color: "#854f0b", letterSpacing: 2, marginTop: 2 }}>
          ...
          {optional.length > 0 && (
            <>
              <div style={{ padding: "8px 20px 4px", background: "#ffffff", fontSize: 9, color: "#5a3a9e", letterSpacing: 2, marginTop: 2 }}>
