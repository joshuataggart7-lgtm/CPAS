...
const C = {
  ...
  green: "#3aaa66", yellow: "#f4c542", red: "#e87c3e", purple: "#aa4aff",
};

const STATUS_COLOR = {
  REQUIRED:    { bg: "#041a0e", border: "#1a6a3a", text: "#3aaa66", badge: "#0a3a1a" },
...
export default function ClauseMatrixUI({ intake, onSectionIGenerated }) {
      ...
      <div style={{ borderBottom: `1px solid ${C.border}`, background: isExpanded ? sc.bg : "transparent" }}>
        ...
        >
          ...
          {showInclude && (
            <div
              ...
              style={{ width: 16, height: 16, border: `1px solid ${isIncluded ? C.green : "#2a4a6a"}`,
        ...
        {isExpanded && (
          <div style={{ padding: "8px 12px 14px 36px", background: sc.bg }}>
            {clause.note && (
              <div style={{ fontSize: 10, color: "#8ab0d0", marginBottom: 10, lineHeight: 1.4 }}>
                📌 {clause.note}
              </div>
            )}
                ...
                {clause.fillIns.map(fi => (
                  <div key={fi.id} style={{ marginBottom: 8 }}>
                    ...
                    <input
                      ...
                      style={{ width: "100%", background: "#0d1f3c", border: `1px solid ${C.border}`,
  ...
  const tabBtn = (id, label, count) => (
    <button
      ...
      style={{ padding: "7px 14px", cursor: "pointer", borderRadius: 3, fontSize: 10, letterSpacing: 1,
               background: activeTab === id ? "#0a2a4a" : "transparent",
  ...
  // ── Main render ───────────────────────────────────────────────
  return (
    <div style={{ background: C.bg, color: C.text, fontFamily: "'IBM Plex Mono', monospace", fontSize: 12 }}>
          ...
          {EXTRA_PARAMS.map(ep => (
            <div
              ...
              style={{ display: "flex", alignItems: "center", gap: 5, cursor: "pointer",
                       background: extraParams[ep.key] ? "#0a2a1a" : C.bg3,
            ...
            >
              <div style={{ width: 12, height: 12, borderRadius: 2, flexShrink: 0,
                             ...
                             border: `1px solid ${extraParams[ep.key] ? C.green : "#2a4a6a"}`,
      ...
      {activeTab === "MATRIX" && (
        <div style={{ overflow: "auto", maxHeight: "60vh" }}>
          {/* Required */}
          <div style={{ padding: "8px 20px 4px", background: "#041a0e", fontSize: 9, color: C.green, letterSpacing: 2 }}>
            ...
            {Object.entries(sf1449).map(([block, field]) => (
              <div key={block} style={{ background: C.bg3, border: `1px solid ${C.border}`, borderRadius: 4, padding: "8px 10px" }}>
                ...
                <input
                  ...
                  style={{ width: "100%", background: "#040d1a", border: `1px solid ${C.border}`,
        ...
        <div style={{ padding: 20, overflow: "auto", maxHeight: "60vh" }}>
          ...
          {UCF_SECTIONS.map(sec => (
            <div key={sec.id} style={{ display: "flex", gap: 10, padding: "10px 0", borderBottom: `1px solid ${C.border}` }}>
              <div style={{ width: 32, height: 32, background: "#0a2a4a", border: `1px solid ${C.blue}`,
