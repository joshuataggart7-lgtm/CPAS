...
function buildSectionM(p) {
  ...
  if (soleSource) {
    ...
    text += `M.2 PRICE REASONABLENESS\nThe Contracting Officer will determine price reasonableness through ${parseFloat(p.value) >= 2500000 ? "certified cost or pricing data per FAR 15.403-4 (TINA threshold: $2.5M)" : "price analysis techniques per FAR 15.404-1, including comparison to prior prices, market data, and independent Government estimate"}.\n\n`;
