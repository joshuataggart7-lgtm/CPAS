...
export const CLAUSE_LIBRARY = [
  ...
  },
  {
    ...
    req: (p) => p.isIdiq || p.value >= 1000000 ? "REQUIRED" : null,
    fillIns: [],
    note: "Required in all IDIQ contracts and contracts > $1M. Lists NASA ombudsman contact.",
  },
  {
    num: "1852.219-74",
  ...
  {
    num: "1852.219-75",
    title: "Small Business Subcontracting Reporting",
    farRef: "NFS 1819.708(b)(2)",
