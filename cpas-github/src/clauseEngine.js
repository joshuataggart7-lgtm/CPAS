...
export const CLAUSE_LIBRARY = [
  ...
  },
  {
    ...
    farRef: "FAR 12.301(c)",
    req: (p) => p.isCommercial === "YES" && p.value > V.SAT ? "REQUIRED" : null,
    alternates: [],
    fillIns: [
  ...
  },
  {
    ...
    fillIns: [],
    note: "Offeror may complete reps/certs in SAM.gov in lieu of this clause.",
  },
  {
    num: "52.212-4",
  ...
  },
  {
    ...
    note: "CO must check each applicable sub-clause within 52.212-5. Many are mandatory based on value thresholds.",
    subClauses: [
      ...
      { sub: "(b)(15)", clause: "52.219-9", title: "Small Business Subcontracting Plan", req: (p) => p.value >= 750000 && !p.isSmallBusiness },
  ...
  },
  {
    ...
    farRef: "FAR 19.708(b)",
    req: (p) => p.value >= 750000 && !p.isSmallBusiness && p.hasSubcontracting ? "REQUIRED" : p.value >= 750000 && !p.isSmallBusiness ? "CONDITIONAL" : null,
  ...
  },
  {
    ...
    farRef: "NFS 1816.506-70 / PCD 25-23 NFS 1812.301(f)(i)(D)",
    req: (p) => p.isIdiq && p.isCommercial === "YES" ? "CONDITIONAL" : null,
    fillIns: [
    ...
    note: "Authorized for commercial IDIQ contracts per NFS 1812.301(f)(i)(D) (PCD 25-23). Use Alternate I. Prescribes task order procedures within the IDIQ.",
  },
  {
    num: "1852.219-74",
    title: "Use of Rural Area Small Businesses",
    farRef: "NFS 1819.7003",
    req: (p) => p.center === "Stennis (SSC)" ? "REQUIRED" : null,
    fillIns: [],
  },
  {
    num: "1852.219-75",
    ...
    req: (p) => p.value >= 750000 && !p.isSmallBusiness ? "REQUIRED" : null,
    fillIns: [],
  ...
  {
    num: "1852.219-76",
    title: "NASA 8(a) Awards",
    farRef: "NFS 1819.811-3(e)",
    req: (p) => p.setAside === "8A" ? "REQUIRED" : null,
    fillIns: [],
  },
  {
    ...
    farRef: "NFS 1823.7001(a)",
    req: (p) => p.performsOnFederalFacility ? "REQUIRED" : "CONDITIONAL",
    fillIns: [],
    note: "Required for all on-site work at NASA facilities.",
  },
  {
    num: "1852.223-71",
    title: "Frequency Authorization",
    farRef: "NFS 1823.7002",
    req: (p) => p.hasRadioFreq ? "CONDITIONAL" : null,
    fillIns: [],
  },
  {
    num: "1852.223-72",
    title: "Safety and Health (Short Form)",
    farRef: "NFS 1823.7001(b)",
  ...
  },
  {
    ...
    req: (p) => p.isRD && p.value <= 500000 ? "REQUIRED" : null,
    fillIns: [],
  },
  {
    num: "1852.227-14",
    ...
    req: (p) => !p.isCommercial && (p.isRD || p.isServicesContract) ? "REQUIRED" : null,
    alternates: ["Alt I", "Alt II", "Alt III", "Alt IV", "Alt V"],
    fillIns: [],
  },
  {
    num: "1852.227-70",
    title: "New Technology and Patent Rights",
...
export function prescribeClauses(params) {
  ...
  const p = {
    ...
    isSmallBusiness:        params.isSmallBusiness === true,
    ...
    isSCA:                  params.isSCA === true || (["SERVICES","AE"].includes(params.reqType) && parseFloat(params.value) > 2500),
    hasSubcontracting:      parseFloat(params.value) >= 750000,
