        ...
        {step.type === "FORM" && step.formType === "NAICS" && (
          <div style={S.panelSection}>
            ...
            <input placeholder="e.g. 481211" value={naicsCustom} onChange={e=>setNaicsCustom(e.target.value)}
              style={{ background:"#ffffff", border:"1px solid " + (naicsCustom?"#1a3a6e":"#1a3a6e"), color:"#e8eef8", padding:"7px 10px", borderRadius:"3px", fontSize:"11px", width:"100%", marginBottom:"8px", fontFamily:"IBM Plex Mono,monospace" }} />
        ...
        {step.type === "FORM" && step.formType === "PSC" && (
          <div style={S.panelSection}>
            ...
            <input placeholder="e.g. V231" value={pscCustom} onChange={e=>setPscCustom(e.target.value)}
              style={{ background:"#ffffff", border:"1px solid " + (pscCustom?"#1a3a6e":"#1a3a6e"), color:"#e8eef8", padding:"7px 10px", borderRadius:"3px", fontSize:"11px", width:"100%", marginBottom:"8px", fontFamily:"IBM Plex Mono,monospace" }} />
  ...
  return (
    <div style={{ padding:"24px", maxWidth:"820px", margin:"0 auto" }}>
      ...
      <button onClick={runAdvisor} disabled={loading || (mode==="QUICK"?(!desc||!dollars):(!fileText))}
        style={{ background:loading?"#eef3fc":"#1a3a6e", border:"1px solid #4a9eff", color:"#2a5aaa", padding:"11px 24px", cursor:loading?"not-allowed":"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px", opacity:loading?0.6:1,marginBottom:"24px"}}>
          ...
          <div>
            ...
            {(result.whyNotFAR15||result.whyNotTM) && (
              <div style={{ background:"#ffffff", border:"1px solid #1a3a6e", borderRadius:"4px", padding:"12px 14px", marginBottom:"12px" }}>
                ...
                {result.whyNotFAR15 && <div style={{ marginBottom:"6px" }}><span style={{ fontSize:"9px", color:"#854f0b", letterSpacing:"1px" }}>FAR PART 15: </span><span style={{ fontSize:"10px", color:"#e8eef8" }}>{result.whyNotFAR15}</span></div>}
                {result.whyNotTM && <div><span style={{ fontSize:"9px", color:"#854f0b", letterSpacing:"1px" }}>T&M/COST-PLUS: </span><span style={{ fontSize:"10px", color:"#e8eef8" }}>{result.whyNotTM}</span></div>}
              </div>
            )}
