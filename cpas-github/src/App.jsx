  ...
  return (
    ...
    <div style={S.app}>
      ...
      <div style={S.hdr}>
        ...
        <button style={{...S.startOver, background:"#1a0a2a", borderColor:"#4a1a6a", color:"#c07aff"}}
          onClick={()=>setShowMod(true)}>
          MOD BUILDER
        </button>
        <button style={{...S.startOver, background:"#0a1a2a", borderColor:"#1a5a8a", color:"#4ac8ff"}}
          onClick={()=>setShowForms(true)}>
          SF FORMS
        </button>
        <button style={{...S.startOver, background:"#1a0a1a", borderColor:"#5a1a5a", color:"#e07ae0"}}
          onClick={()=>setShowBPA(true)}>
          BPA CALL
        </button>
        <button style={{...S.startOver, background:"#0a1a0a", borderColor:"#1a5a2a", color:"#4aff8a"}}
          onClick={()=>setShowUCF(true)}>
          UCF D/E/F
        </button>
        <button style={{...S.startOver, background:"#1a1a0a", borderColor:"#5a5a1a", color:"#f4c542"}}
          onClick={()=>setShowAwardTools(true)}>
          AWARD TOOLS
        </button>
        <button style={{...S.startOver, background:"#1a0a0a", borderColor:"#5a1a1a", color:"#ff6a6a"}}
          onClick={()=>setShowAdminTools(true)}>
          CONTRACT ADMIN
        </button>
        <button style={{...S.startOver, background:"#0a1a1a", borderColor:"#1a5a5a", color:"#4affff"}}
