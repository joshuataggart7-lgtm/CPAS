...
function RouteAdvisor({ onUseRecommendation }) {
  ...
  const btn = (active) => ({ padding:"8px 16px", cursor:"pointer", borderRadius:"3px", fontSize:"10px", letterSpacing:"1px", border:"1px solid "+(active?"#5ba3ff":"#2255a4"), background:active?"#1a3a6e":"transparent", color:active?"#2a5aaa":"#7090b8" });
    ...
    <div style={{ padding:"20px", maxWidth:"800px", margin:"0 auto" }}>
      ...
      <div style={{ marginBottom:"14px" }}>
        ...
        <div style={{ display:"flex", gap:"8px", flexWrap:"wrap" }}>
          {DOC_TYPES.map(dt => (
            <button key={dt.key}
              style={{ background: docType===dt.key ? "#1a3a6e":"#eef3fc", border:"1px solid "+(docType===dt.key?"#5ba3ff":"#2255a4"), color: docType===dt.key?"#2a5aaa":"#7090b8", padding:"6px 12px", cursor:"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px" }}
