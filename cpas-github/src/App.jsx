...
const S = {
  ...
  laneTag:{ display:"inline-flex", alignItems:"center", gap:"6px",
            ...
            fontWeight:"500" },
  phCard:(open,done)=>({ background:C.bg2, border:done?"1px solid #9fe1cb":open?"1px solid "+C.blue:
          "1px solid "+C.border, borderRadius:"10px", overflow:"hidden", marginBottom:"8px",
          transition:"all .2s", boxShadow:open?"0 2px 8px rgba(26,58,110,0.08)":"none" }),
  phHdr:(open,done)=>({ padding:"13px 18px", display:"flex", alignItems:"center", gap:"10px",
          background:done?"#f0faf6":open?"#f0f5ff":"transparent", cursor:"pointer" }),
  phTitle:{ flex:1, fontWeight:"600", fontSize:"13px", color:C.text },
  ...
  stepRow:(done)=>({ display:"flex", alignItems:"flex-start", gap:"10px",
          ...
          border:done?"1px solid #9fe1cb":"1px solid "+C.border,
  ...
  stepTitle:{ fontWeight:"500", fontSize:"13px", color:C.text },
  ...
  panelLabel:{ fontSize:"10px", color:C.muted, letterSpacing:"1px", marginBottom:"8px",
               textTransform:"uppercase" },
  secHdr:{ fontSize:"10px", color:C.blue2, letterSpacing:"1px", marginBottom:"8px",
           borderBottom:"1px solid "+C.border, paddingBottom:"4px", marginTop:"18px",
           textTransform:"uppercase" },
