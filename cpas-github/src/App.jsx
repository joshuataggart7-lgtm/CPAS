  ...
  if (!isMicro) {
    ...
    phases.push({ id:"P4", title:"Market Research",
      steps:[
        ...
        { id:"P4S2", title:"Sources Sought / RFI — REQUIRED for >$50M", type:"GENERATE", docType:"SOURCES_SOUGHT", nfs:"NFS CG 1805.11 / NFS 1805.205-70 (PCD 25-16) — mandatory >$50M min 10 business days SAM.gov. NFS CG 1805.10: RFI within 30 days of concept approval; requirements package within 60 days of RFI closure; delays >14 days require leadership engagement" },
    ...
    phases.push({ id:"P6", title:"Evaluation & Award",
      steps:[
        ...
        { id:"P6S6", title:"NASA Notification of Contract Action / ANOSCA", type:"GENERATE", docType:"ANOSCA" },
      ]
    });
...
const NEAR_MAP = {
  ...
  ANOSCA:          {fe:106,cat:"Award and Administration",folder:"NASA Notification of Contract Action / ANOSCA / HQ Public Announcement"},
    ...
    try {
      ...
      const parsed = {
        primary: {
          ...
          timelineExplain:      gf("WEEKS_WHY") || gf("TIMELINE_EXPLAIN") || "",
