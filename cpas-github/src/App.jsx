...
function buildRoadmap(intake) {
  ...
  phases.push({ id:"P1", title:"Package Validation",
    steps:[
      ...
      ...(reqType === "SERVICES" ? [{ id:"P1S6", title:"Inherently Governmental Determination", type:"CHECK", nfs:"FAR 7.503 / NFS 1807 (Inherently governmental determination)" }] : []),
  ...
  if (!isMicro) {
    ...
    phases.push({ id:"P5", title:"Solicitation",
      steps:[
        ...
        ...((lane === "FAR_15" || (lane === "FAR_12" && parseFloat(intake.value) > 250000 && competitionStrategy !== "SOLE_SOURCE")) ? [
    ...
    phases.push({ id:"P6", title:"Evaluation & Award",
      steps:[
        ...
        ...((lane === "FAR_15" || (lane === "FAR_12" && parseFloat(intake.value) > 250000 && competitionStrategy !== "SOLE_SOURCE")) ? [{ id:"P6S2", title:"Technical Evaluation", type:"CHECK" }] : []),
...
const STEP_CHECKS = {
  ...
  P2S5: [
    ...
    "JOFOC approved at correct authority level (CO/<$900K · CA/$900K-$20M · HCA/$20M-$150M · SPE/>$150M)?",
