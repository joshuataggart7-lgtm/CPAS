    ...
    try {
      ...
      const parsed = {
        primary: {
          ...
          timelineExplain:      gf("WEEKS_WHY") || gf("TIMELINE_EXPLAIN") || (parseInt(gf("WEEKS")) ? "Timeline driven by " + (gf("BURDEN_WHY") || "documentation and approval requirements") : ""),
