...
function HQDashboard({ onClose }) {
  ...
  const tab = (id, label) => (
    <button onClick={()=>setActiveTab(id)} style={{
      ...
      border: `1px solid ${activeTab===id ? "#1a3a6e" : "#1a3a6e"}`,
      color: activeTab===id ? "#1a3a6e" : "#6b7a99",
  ...
  const statBox = (label, value, color="#1a3a6e", sub) => (
  ...
  if (!authed) return (
    <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.85)", zIndex:998, display:"flex", alignItems:"center", justifyContent:"center" }}>
      <div style={{ background:"#ffffff", border:"1px solid #2a4a7a", borderRadius:8, padding:40, width:360, textAlign:"center" }}>
        <div style={{ color:"#854f0b", fontWeight:"bold", fontSize:13, letterSpacing:2, marginBottom:4 }}>HQ LEADERSHIP DASHBOARD</div>
        <div style={{ color:"#6b7a99", fontSize:11, marginBottom:24 }}>Restricted Access — Enter PIN to continue</div>
        <div style={{ color:"#4a5a78", fontSize:10, letterSpacing:2, marginBottom:8 }}>ACCESS PIN</div>
        ...
        <div style={{ flex:1, overflow:"auto", padding:20 }}>
          {loading ? (
            ...
            <>
              ...
              {activeTab === "overview" && (
                <div>
                  ...
                  <div style={{ display:"flex", gap:12, marginBottom:20, flexWrap:"wrap" }}>
                    {statBox("Total Packages", total, "#1a3a6e")}
                  ...
                  {/* Status breakdown */}
                  <div style={{ color:"#1a3a6e", fontSize:10, letterSpacing:2, marginBottom:10 }}>STATUS BREAKDOWN</div>
                  {barChart([
                  ...
                  ], item => item.label==="PENDING"?"#ffaa30":item.label==="ASSIGNED"?"#1a3a6e":item.label==="IN PROGRESS"?"#0f6e56":"#a32d2d")}

                  {/* Urgency breakdown */}
                  <div style={{ color:"#1a3a6e", fontSize:10, letterSpacing:2, marginBottom:10, marginTop:20 }}>URGENCY BREAKDOWN</div>
                  {barChart([
              ...
              {activeTab === "pipeline" && (
                <div>
                  <div style={{ color:"#1a3a6e", fontSize:10, letterSpacing:2, marginBottom:12 }}>ALL PACKAGES — ${(totalValue/1000000).toFixed(1)}M TOTAL PIPELINE VALUE</div>
                  {data.sort((a,b)=>new Date(b.submitted_at)-new Date(a.submitted_at)).map((pkg,i) => {
                    ...
                    const statusColor = {PENDING:"#ffaa30",ASSIGNED:"#1a3a6e",IN_PROGRESS:"#0f6e56",REJECTED:"#a32d2d"}[pkg.status]||"#6b7a99";
                    return (
                ...
                <div>
                  {highValue.length > 0 && (
                    <div style={{ marginBottom:20 }}>
                      <div style={{ color:"#854f0b", fontSize:10, letterSpacing:2, marginBottom:10 }}>
                  ...
                  {stalled.length > 0 && (
                    <div style={{ marginBottom:20 }}>
                      <div style={{ color:"#a32d2d", fontSize:10, letterSpacing:2, marginBottom:10 }}>
              ...
              {activeTab === "centers" && (
                <div>
                  <div style={{ color:"#1a3a6e", fontSize:10, letterSpacing:2, marginBottom:12 }}>ACQUISITION ACTIVITY BY CENTER</div>
                    ...
                    return (
                      <div key={i} style={{ background:"#eef1f6", border:"1px solid #1a3a6e", borderRadius:6,
                        ...
                        <div style={{ marginTop:10, background:"#0d1f38", borderRadius:3, height:6, overflow:"hidden" }}>
                          <div style={{ width:`${(count/total)*100}%`, background:"#1a3a6e", height:"100%", borderRadius:3 }} />
                        </div>
                      </div>
                    );
                  })}
