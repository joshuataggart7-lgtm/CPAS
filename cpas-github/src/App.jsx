      ...
      <div style={{ background:"#ffffff", border:"1px solid #2a4a7a", borderRadius:8, padding:40, width:360, textAlign:"center" }}>
        ...
        <div style={{ display:"flex", gap:8, marginTop:16 }}>
          <button onClick={tryPin} style={{ flex:1, background:"#1a3a6e", border:"1px solid #2a6aaa",
            color:"#1a3a6e", padding:"10px", borderRadius:4, cursor:"pointer", fontSize:12, fontWeight:"bold" }}>
            ENTER
          </button>
          <button onClick={onClose} style={{ flex:1, background:"#f0f4f8", border:"1px solid #1a2a4a",
            color:"#6b7a99", padding:"10px", borderRadius:4, cursor:"pointer", fontSize:12 }}>
            CANCEL
          </button>
        </div>
      </div>
        ...
        <div style={{ flex:1, overflow:"auto", padding:20 }}>
          ...
          {!email ? (
            <div>
              ...
              <button onClick={login} style={{ width:"100%", background:"#1a3a6e", border:"1px solid #2a6aaa", color:"#2a5aaa",
        ...
        <div style={{ position:"absolute", inset:0, background:"rgba(0,0,0,0.45)", display:"flex", alignItems:"center", justifyContent:"center" }}>
          <div style={{ background:"#ffffff", border:`1px solid ${action.type === "reassign" ? "#4a7abf" : "#9fe1cb"}`, borderRadius:8, padding:28, width:400, maxWidth:"95vw" }}>
            ...
            {action.type === "reassign" && (
              <div style={{ background:"#ffffff", border:"1px solid #1a3a6e", borderRadius:4, padding:"8px 12px", marginBottom:12, fontSize:11, color:"#6b7a99" }}>
            ...
            <div style={{ display:"flex", gap:8 }}>
              ...
              <button onClick={()=>setAction(null)} style={{ flex:1, background:"#ffffff", border:"1px solid #1a2a4a",
                color:"#6b7a99", padding:"9px", borderRadius:4, cursor:"pointer", fontSize:12 }}>
                CANCEL
              </button>
            </div>
          </div>
          ...
          <div style={{ background:"#ffffff", border:"1px solid #7a2a2a", borderRadius:8, padding:28, width:400, maxWidth:"95vw" }}>
            ...
            <div style={{ display:"flex", gap:8 }}>
              <button onClick={doReject} disabled={submitting || !rejectReason.trim()}
                style={{ flex:1, background:"#fff0f0", border:"1px solid #cc4a4a", color:"#e05555",
                  padding:"9px", borderRadius:4, cursor:"pointer", fontSize:12, fontWeight:"bold",
...
function DownloadPDFButton({ endpoint, buildPayload, filename, label }) {
  ...
  return (
    <div style={{ flex:1 }}>
      <button
        style={{ background: status === "error" ? "#fff0f0" : "#1a3a6e", border:"1px solid "+status === "error" ? "#7a2252" : "#5ba3ff", color: status === "error" ? "#7a2252" : "#2a5aaa", padding:"10px", cursor:"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px", width:"100%", opacity: status === "loading" ? 0.6 : 1 }}
        onClick={handleClick}
          ...
          {!email ? (
            <div>
              ...
              <button onClick={login}
                style={{width:"100%",background:"#1a3a6e",border:"1px solid #2a6aaa",color:"#1a3a6e",
                        padding:"9px",borderRadius:4,cursor:"pointer",fontSize:12,fontWeight:"bold"}}>
                VIEW MY QUEUE
              </button>
            </div>
