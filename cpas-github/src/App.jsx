...
function RouteAdvisor({ onUseRecommendation }) {
  ...
  return (
    <div style={{ padding:"24px", maxWidth:"820px", margin:"0 auto" }}>
      <div style={{ fontSize:"10px", color:"#4a7aaa", letterSpacing:"2px",marginBottom:"4px"}}>ACQUISITION COACH</div>
      <div style={{ fontSize:"20px", color:"#c8d8f0", fontWeight:700,marginBottom:"4px"}}>Acquisition Approach Coach</div>
      <div style={{ fontSize:"11px", color:"#4a7aaa",marginBottom:"20px"}}>Get expert acquisition strategy guidance with pros, cons, and alternatives. You make every decision — this is your coach, not your CO.</div>
    ...
    <div style={S.app}>
      ...
      <div style={S.hdr}>
        ...
        <button style={{...S.startOver}} onClick={()=>setScreen(screen==="ROUTE"?"INTAKE":"ROUTE")}>
          {screen==="ROUTE" ? "< BACK" : "ACQUISITION COACH"}</button>
