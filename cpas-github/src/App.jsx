...
function SubmitModal({ docType, content, intake, onClose, onSubmitted }) {
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(26,58,110,0.4)",zIndex:999,display:"flex",alignItems:"center",justifyContent:"center"}}>
...
function ReviewerDashboard({ onClose }) {
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(26,58,110,0.4)",zIndex:998,display:"flex",alignItems:"center",justifyContent:"center"}}>
...
function CPAS() {
  ...
  return (
    ...
    {showContractRecord && (
      <div style={{position:"fixed",inset:0,background:"rgba(26,58,110,0.35)",zIndex:990,display:"flex",alignItems:"stretch",justifyContent:"flex-end"}}>
