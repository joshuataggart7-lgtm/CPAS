...
function BranchChiefDashboard({ onClose }) {
  ...
  const inp = { background: "#eef3fc", border: "1px solid #1a3a6e", color: "#e8eef8", padding: "8px 10px",
...
function RouteAdvisor({ onUseRecommendation }) {
  ...
  const inp = { background:"#ffffff", border:"1px solid #1a3a6e", color:"#1a2332", padding:"8px 10px", borderRadius:"3px", fontSize:"11px", width:"100%", fontFamily:"IBM Plex Mono,monospace", outline:"none" };
  const btn = (active) => ({ padding:"8px 16px", cursor:"pointer", borderRadius:"3px", fontSize:"10px", letterSpacing:"1px", border:"1px solid "+(active?"#5ba3ff":"#1a3a6e"), background:active?"#1a3a6e":"transparent", color:active?"#2a5aaa":"#6b7a99" });
  ...
  return (
    <div style={{ padding:"24px", maxWidth:"820px", margin:"0 auto" }}>
      ...
      {error && <div style={{ color:"#a32d2d", fontSize:"11px", marginBottom:"12px", padding:"8px", border:"1px solid #cc3333", borderRadius:"3px" }}>{error}</div>}

      <button onClick={runAdvisor} disabled={loading || (mode==="QUICK"?(!desc||!dollars):(!fileText))}
        style={{ background:loading?"#eef1f6":"#1a3a6e", border:"none", color:loading?"#6b7a99":"#fff", padding:"11px 24px", cursor:loading?"not-allowed":"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px", opacity:loading?0.6:1,marginBottom:"24px"}}>
...
function DocumentReview({ intake, initialDocType }) {
  ...
  const inp = { background:"#ffffff", border:"1px solid #1a3a6e", color:"#1a2332", padding:"8px 10px", borderRadius:"3px", fontSize:"11px", width:"100%", fontFamily:"IBM Plex Mono,monospace" };
    ...
    <div style={{ padding:"20px", maxWidth:"800px", margin:"0 auto" }}>
      ...
      <div style={{ marginBottom:"14px" }}>
        ...
        <div style={{ display:"flex", gap:"8px", flexWrap:"wrap" }}>
          {DOC_TYPES.map(dt => (
            <button key={dt.key}
              style={{ background: docType===dt.key ? "#1a3a6e":"#eef3fc", border:"1px solid "+(docType===dt.key?"#5ba3ff":"#1a3a6e"), color: docType===dt.key?"#2a5aaa":"#6b7a99", padding:"6px 12px", cursor:"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px" }}
      ...
      <button
        style={{ background: loading?"#eef3fc":"#1a3a6e", border:"1px solid #4a9eff", color:"#2a5aaa", padding:"10px 20px", cursor: loading||!text||extracting?"not-allowed":"pointer", borderRadius:"3px", fontSize:"11px", letterSpacing:"1px", opacity: loading||!text||extracting?0.6:1,marginBottom:"20px"}}
        onClick={runReview}
      ...
      {result && (
        <div style={{ animation:"slideIn .3s ease" }}>
          <div style={{ display:"flex", alignItems:"center", gap:"12px",marginBottom:"16px"}}>
            <div style={{ fontSize:"12px", letterSpacing:"0.5px", color:RATING_COLOR[result.overallRating]||"#e8eef8", border:"1px solid "+RATING_COLOR[result.overallRating]||"#1a3a6e", padding:"4px 10px", borderRadius:"3px" }}>
              {result.overallRating?.replace("_"," ")}
            </div>
            <div style={{ fontSize:"11px", color:"#6b7a99" }}>{result.docType}</div>
          </div>

          <div style={{ fontSize:"11px", color:"#1a2332", lineHeight:1.7, marginBottom:"16px", padding:"12px", background:"#ffffff", border:"1px solid #1a3a6e", borderRadius:"4px" }}>
            {result.summary}
          </div>
