...
function buildRoadmap(intake) {
  ...
  phases.push({ id:"P1", title:"Package Validation",
    steps:[
      ...
      { id:"P1S4", title:"IGCE", reviewType:"IGCE", type:"GENERATE", docType:"IGCE", packages:[{key:"IGCE",label:"IGCE Document",docType:"IGCE"}], nfs:"NFS 1807.105(a)(3)" },
  ...
  if (!isMicro) {
    ...
    phases.push({ id:"P5", title:"Solicitation",
      steps:[
        ...
        ...((lane === "FAR_15" || (lane === "FAR_12" && parseFloat(intake.value) > 250000)) ? [
    ...
    phases.push({ id:"P6", title:"Evaluation & Award",
      steps:[
        ...
        ...((lane === "FAR_15" || (lane === "FAR_12" && parseFloat(intake.value) > 250000)) ? [{ id:"P6S2", title:"Technical Evaluation", type:"CHECK" }] : []),
