    ...
    try {
      ...
      const res = await fetch("/.netlify/functions/generate-docx", {
        ...
        body: JSON.stringify({
          ...
          title: existingIntake?.reqTitle || params.title || params.contractNumber || label,
          contractNumber: params.contractNumber || existingIntake?.contractNumber || "",
          value: existingIntake?.value || params.value || "",
          naics: existingIntake?.naics || params.naics || "",
          contractType: existingIntake?.contractType || params.contractType || "",
