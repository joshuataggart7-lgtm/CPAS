            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              ...
              <QCard q="How long do you need the contractor?" sub="Base period — we'll add options later if needed">
                <select style={inp} value={pkg.popMonths} onChange={e => set("popMonths", e.target.value)}>
                  {[["3","3 months"],["6","6 months"],["12","1 year"],["18","18 months"],["24","2 years"],["36","3 years"],["48","4 years"],["60","5 years"],["60","5 year base, no options"],["120","10-year IDIQ ordering period"]].map(([v,l]) => <option key={v} value={v}>{l}</option>)}
                </select>
