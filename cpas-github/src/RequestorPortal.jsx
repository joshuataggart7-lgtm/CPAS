          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: C.muted, marginBottom: 12 }}>
              ...
              {pkg.igceMode !== "CATALOG"
                ...
                : <span style={{fontSize:11,color:"#8a9ab0"}}>Enter pre-priced catalog rates (aircraft hourly/daily, unit prices, etc.). Common for IDIQ contracts with fixed rate cards.</span>
              }
            </div>
