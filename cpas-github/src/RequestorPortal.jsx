            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              ...
              <div>
                ...
                <select style={inp} value={pkg.reqCenter} onChange={e => {
                  ...
                  // Auto-populate branch chief email based on center
                  if (CENTER_BC_EMAILS[center] && !pkg.branchChiefEmail) {
                    set("branchChiefEmail", CENTER_BC_EMAILS[center]);
                  }
                }}>
              ...
              <div>
                <Lbl t="Procurement Office / Branch Chief Email" />
                <input style={inp} value={pkg.branchChiefEmail} onChange={e => set("branchChiefEmail", e.target.value)}
                  placeholder="Auto-fills when you select your center above" />
              </div>
            </div>
