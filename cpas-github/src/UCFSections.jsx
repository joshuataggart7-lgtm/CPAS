    ...
    <>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8 }}>
        <div onClick={() => set("hazmat", !d.hazmat)}
          style={{ width: 13, height: 13, border: `1px solid ${d.hazmat ? C.red : "#8896b0"}`, borderRadius: 2,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8 }}>
        <div onClick={() => set("dataPackaging", !d.dataPackaging)}
          style={{ width: 13, height: 13, border: `1px solid ${d.dataPackaging ? C.green : "#8896b0"}`, borderRadius: 2,
    ...
    <>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:8 }}>
        <div onClick={() => set("testReqs", !e.testReqs)}
          style={{ width:13, height:13, border:`1px solid ${e.testReqs ? C.blue : "#8896b0"}`, borderRadius:2,
    ...
    <>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:6 }}>
        <div onClick={() => set("remoteWork", !f.remoteWork)}
          style={{ width:13, height:13, border:`1px solid ${f.remoteWork ? C.green : "#8896b0"}`, borderRadius:2,
      ...
      {f.deliverables.map((del, i) => (
        <div key={del.id} style={{ background:C.bg3, border:`1px solid ${C.border}`, borderRadius:4, padding:"8px 10px", marginBottom:6 }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:4 }}>
            ...
            <button onClick={() => removeDel(del.id)} style={{ background:"none", border:"none", color:"#fff0f0", cursor:"pointer", fontSize:13 }}>×</button>
          </div>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:6 }}>
        <div onClick={() => set("stopWork", !f.stopWork)}
          style={{ width:13, height:13, border:`1px solid ${f.stopWork ? C.yellow : "#8896b0"}`, borderRadius:2,
        ...
        {tabs.map(tab => (
          <button key={tab.id} onClick={() => setActiveSection(tab.id)}
            style={{ padding: "6px 16px", borderRadius: 3, cursor: "pointer", fontSize: 10, fontWeight: "bold",
                     background: activeSection === tab.id ? "#eef3fc" : C.bg3,
