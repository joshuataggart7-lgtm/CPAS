...
const ADJECTIVAL_RATINGS = [
  ...
  { id: "VERY_GOOD",      label: "Very Good",       color: "#1a3a6e", bg: "#041020",
  ...
  { id: "SATISFACTORY",   label: "Satisfactory",    color: "#854f0b", bg: "#1a1a04",
  ...
  { id: "UNACCEPTABLE",   label: "Unacceptable",    color: "#ff4a4a", bg: "#fff0f0",
            ...
            <>
              ...
              {factors.length > 1 && (
                <button onClick={() => { setFactors(f => f.filter(x => x.id !== activeFactor.id)); setActiveFactorId(factors[0]?.id); }}
                  style={{ background: "#fff0f0", border: "1px solid #4a1a1a", color: "#aa4a4a", padding: "5px 14px",
